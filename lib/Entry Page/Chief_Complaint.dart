...
class _ChiefComplaintState extends State<ChiefComplaint> {
  ...
  Future<void> _loadSharedPreferences() async {
    ...
    if (savedItems != null) {
      setState(() {
        medicalConditions.addAll(savedItems);
        filteredList = medicalConditions;
  ...
  Future<void> _deleteSelectedItems() async {
    if (selectedItems.isNotEmpty) {
      ...
      if (confirmDelete != null && confirmDelete) {
        setState(() {
          medicalConditions.removeWhere((item) => selectedItems.contains(item));
          filteredList.removeWhere((item) => selectedItems.contains(item));
          selectedItems.clear();
        });
        await _prefs.setStringList('savedItems', medicalConditions);
      }
    }
  }
