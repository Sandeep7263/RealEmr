...
class DiagnosisSelect extends StatefulWidget {
  ...
  @override
  _DiagnosisSelectState createState() => _DiagnosisSelectState();
}

class _DiagnosisSelectState extends State<DiagnosisSelect> {
  ...
  Future<void> _loadSharedPreferences() async {
    ...
    if (savedItems != null) {
      setState(() {
        Diagnosis.addAll(savedItems);
        filteredList = Diagnosis;
  ...
  Future<void> _deleteSelectedItems() async {
    if (selectedItems.isNotEmpty) {
      ...
      if (confirmDelete != null && confirmDelete) {
        setState(() {
          Diagnosis.removeWhere((item) => selectedItems.contains(item));
          filteredList.removeWhere((item) => selectedItems.contains(item));
          selectedItems.clear();
        });
        await _prefs.setStringList('savedItems', Diagnosis);
      }
    }
  }

  void _saveSelectedItems() async {
    await _prefs.setStringList('savedItems', selectedItems);
